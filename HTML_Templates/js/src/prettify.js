...
(function () {
  ...
  var JAVA_KEYWORDS = COMMON_KEYWORDS +
      "access alias ANYTYPE appstate ARRAY attribute basedon BOOLEAN break builtin case CHAR const continue currentfile currentpath critical DATACLASS DATATYPE default derived dll do DOUBLE each else enum except exit extern FALSE FLOAT for goto GUITYPE HANDLE hidecalls if in inout INT INTEGER is LIST LONG none null NUMBER OBJ obsolete OF optional out parallel parent private property public raise REAL record rendezvous reraise return select SEMAPHORE SET share SHORT size spawn step STRING switch tag testcase this to TRUE type UNSIGNED unsupported use varargs void while winclass WINDOW NULL" +
